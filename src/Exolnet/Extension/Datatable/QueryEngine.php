...
class QueryEngine extends \Chumper\Datatable\Engines\BaseEngine
{
	/**
	 * @var Builder
	 */
	...
	/*
	 * Custom code for QueryEngine
	 */

	protected $postQueryEvents = [];

	public function doPostQuery(Closure $callback)
	{
		$this->postQueryEvents[] = $callback;

		return $this;
	}

	protected function doPostQueryEvents(Collection $collection)
	{
		foreach ($this->postQueryEvents as $postQueryEvent) {
			$postQueryEvent($collection);
		}
	}
}
